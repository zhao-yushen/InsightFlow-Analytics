...
pages = {
    ...
    t("nav.diagnose"): [
        ...
        st.Page(
            profit.render, title=t("page.profit.title"), icon=":material/paid:", url_path="profit"
        ),
        st.Page(
            customers.render,
    ...
    t("nav.plan"): [
        st.Page(
            planning.render,
            title=t("page.planning.title"),
            icon=":material/event_upcoming:",
            url_path="planning",
        ),
        st.Page(
            decision_lab.render,
            title=t("page.decision_lab.title"),
            icon=":material/science:",
            url_path="decision-lab",
        ),
        st.Page(
            experiments.render,
            title=t("page.experiments.title"),
