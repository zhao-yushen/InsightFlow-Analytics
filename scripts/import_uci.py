...
def main() -> None:
    parser = argparse.ArgumentParser(description="Import UCI Online Retail/Online Retail II Excel or CSV")
    parser.add_argument("--input", required=True, help="Path to online_retail_II.xlsx or compatible CSV")
    ...
    result = clean_transactions(df, source_profile="uci_online_retail", transaction_status="Verified")
