...
def render() -> None:
    ...
    for tab, dimension in zip(tabs, ["country", "category", "channel"]):
        with tab:
    ...
    selected_dimension = st.selectbox(lt("拆解维度"), ["country", "category", "channel"], format_func={"country": lt("国家/地区"), "category": lt("品类"), "channel": lt("渠道")}.get)
